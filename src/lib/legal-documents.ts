...
export const LEGAL_NOT_ADVICE_NOTICE =
  "This document is an internal operating draft for Fitness and is not legal advice. Review it with qualified counsel before wider paid launch.";
