...
export const mobileRegressionScenarios: readonly MobileFixtureScenario[] = [
  ...
  buildWorkoutFixture({
    ...
    fixtureState: "session-logger-strength-weight-v1",
    lastInteractiveRowBottom: 696,
    activeSession: true,
    statusChips: ["in-progress"],
  ...
  buildWorkoutFixture({
    ...
    fixtureState: "session-logger-bodyweight-reps-v1",
    lastInteractiveRowBottom: 696,
    activeSession: true,
    statusChips: ["in-progress"],
  ...
  buildWorkoutFixture({
    ...
    fixtureState: "session-logger-cardio-time-v1",
    lastInteractiveRowBottom: 696,
    activeSession: true,
    statusChips: ["in-progress"],
  ...
  buildWorkoutFixture({
    ...
    fixtureState: "session-logger-cardio-time-distance-v1",
    lastInteractiveRowBottom: 696,
    activeSession: true,
    statusChips: ["in-progress"],
  ...
  buildWorkoutFixture({
    ...
    fixtureState: "session-logger-cardio-distance-v1",
    lastInteractiveRowBottom: 696,
    activeSession: true,
    statusChips: ["in-progress"],
  ...
  buildWorkoutFixture({
    ...
    fixtureState: "session-logger-calories-v1",
    lastInteractiveRowBottom: 696,
    activeSession: true,
    statusChips: ["in-progress"],
