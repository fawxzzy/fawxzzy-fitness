...
export const mobileRegressionScenarios: readonly MobileFixtureScenario[] = [
  ...
  buildWorkoutFixture({
    id: "session-post-close-feedback",
    family: "Session / logging",
    name: "Session logger: post-close feedback",
    fixture: "post-close-feedback",
    fixtureState: "session-post-close-feedback-v2",
    lastInteractiveRowBottom: 696,
    activeSession: true,
    statusChips: ["logged"],
    cardStates: [{ cardId: "logger-bodyweight-reps", state: "completed", badgeText: "Closed" }],
    currentSessionSaveSetHeaderPinned: true,
  }),
  buildWorkoutFixture({
    id: "session-auto-progression-confirmation",
    family: "Session / logging",
    name: "Session logger: automatic progression confirmation",
    fixture: "auto-progression-confirmation",
    fixtureState: "session-auto-progression-confirmation-v1",
    lastInteractiveRowBottom: 696,
    activeSession: true,
    statusChips: ["logged"],
    cardStates: [{ cardId: "logger-strength-weight", state: "completed", badgeText: "Saved" }],
    currentSessionSaveSetHeaderPinned: true,
  }),
  buildWorkoutFixture({
  ...
  buildRoutinesFixture({
    id: "routines-current-add-day-duplicate",
    family: "Exercise cards",
    name: "Routines: current add-day duplicate chooser",
    fixture: "current-add-day-duplicate",
    fixtureState: "routines-current-add-day-duplicate-v1",
    currentView: "current",
  }),
  buildRoutinesFixture({
  ...
  buildRoutinesFixture({
    id: "routines-list-create-duplicate",
    family: "Exercise cards",
    name: "Routines: create duplicate chooser",
    fixture: "list-create-duplicate",
    fixtureState: "routines-list-create-duplicate-v1",
    currentView: "list",
    historyLogHeaderCount: 1,
  }),
  buildDayFixture({
  ...
  buildSimpleFixture({
    id: "history-detail-feedback-note",
    route: "historyDetail",
    screen: "history-detail",
    family: "Session summaries",
    name: "History detail: feedback note",
    fixture: "feedback-note",
    fixtureState: "history-detail-feedback-note-v1",
    statusChips: ["logged"],
    cardStates: [{ cardId: "history-detail-feedback-note", state: "completed", badgeText: "Expanded" }],
    historyHeaderOwnerCount: 1,
    historySurfaceToken: "history-detail",
  }),
  buildSimpleFixture({
