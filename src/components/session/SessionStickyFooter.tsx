...
export function SessionStickyFooter({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <div
      className={cn(
        "sticky bottom-0 z-30 mt-auto -mx-1 px-1 pb-[calc(var(--app-safe-bottom)+2px)] pt-2.5",
        "[padding-bottom:max(calc(env(safe-area-inset-bottom)+2px),calc(var(--app-safe-bottom)+2px))]",
