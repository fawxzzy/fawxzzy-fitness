...
export const BOTTOM_ACTION_BUTTON_BASE_CLASS_NAME = [
  "bottom-action",
  "relative inline-flex min-h-11 items-center justify-center gap-2 rounded-[var(--bottom-action-radius)] border px-3.5 text-center text-[0.925rem] font-semibold leading-[1.08] tracking-[0.01em]",
