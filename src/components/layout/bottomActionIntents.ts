...
export const BOTTOM_ACTION_BUTTON_BASE_CLASS_NAME = [
  "bottom-action",
  "relative inline-flex min-h-[40px] items-center justify-center gap-1.5 rounded-full border px-3 text-center text-[0.9rem] font-semibold leading-[1.08] tracking-[0.01em]",
