...
export function SessionHeaderControls({
  ...
  return (
    <div className="sticky top-0 z-40 px-1 pt-[max(0.15rem,env(safe-area-inset-top))]">
      <section className="overflow-hidden rounded-[1.5rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.1),rgba(255,255,255,0.045))] px-3.5 py-2.5 shadow-[0_16px_32px_rgba(0,0,0,0.2)] backdrop-blur-md">
        ...
        <div className="mt-1.5 min-h-[1rem] px-0.5 text-xs text-muted">
          <OfflineSyncBadge />
        </div>
      </section>
    </div>
