...
const shellBaseClassName = "relative overflow-visible rounded-[1rem] border border-[rgb(var(--border-strong)/0.18)] bg-[rgb(var(--surface-1-rgb)/0.28)] shadow-[0_10px_24px_rgba(0,0,0,0.12)] transition-colors focus-within:border-[rgb(var(--button-primary-border)/0.42)]";
