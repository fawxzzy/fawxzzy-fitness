  ...
  return createPortal(
    <div className="fixed inset-0 z-[120] flex items-end justify-center" role="presentation">
      ...
      <div
        ...
        className={`relative z-10 flex max-h-[min(100dvh,48rem)] w-full max-w-[min(640px,100vw-0.75rem)] min-w-0 flex-col overflow-hidden rounded-t-[1.9rem] border border-border/45 bg-[rgb(var(--surface-rgb)/0.985)] shadow-[0_-14px_40px_rgba(0,0,0,0.34)] ${className ?? ""}`}
      >
