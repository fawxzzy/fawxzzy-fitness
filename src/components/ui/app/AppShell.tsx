...
export function AppShell({
  ...
  return (
    <div
      className={cn("app-shell relative isolate flex h-full min-h-0 min-w-0 max-w-full flex-1 flex-col overflow-x-hidden overflow-y-hidden bg-[rgb(var(--bg-app))] pt-[var(--app-top-offset)] touch-pan-y [overscroll-behavior-x:none]", className)}
