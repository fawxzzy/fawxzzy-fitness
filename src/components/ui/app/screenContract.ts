...
export const screenRecipes: Record<ScreenContractName, ScreenRecipe> = {
  currentSession: {
    ...
    headerPanelClassName: "space-y-3 p-4 pt-[calc(var(--app-standalone-safe-top,0px)+1rem)]",
  ...
  exerciseLog: {
    ...
    scaffoldClassName: "space-y-3",
    headerPanelClassName: "p-4 pt-[calc(var(--app-standalone-safe-top,0px)+1.2rem)]",
  ...
  routinesOverview: {
    ...
    headerPanelClassName: "space-y-4 p-4 pt-[calc(var(--app-standalone-safe-top,0px)+1.2rem)]",
    sectionClassName: "space-y-3 p-4",
    sectionShellClassName: "space-y-4 p-4",
    sectionBodyClassName: "space-y-3",
  },
