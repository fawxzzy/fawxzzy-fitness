...
export const SHARED_OVERLAY_PANEL_SURFACE_CLASS_NAME = cn(
  ...
  `relative isolate mx-auto ${SHARED_OVERLAY_PANEL_MAX_WIDTH_CLASS_NAME} overflow-hidden !bg-[rgb(var(--bg-app))] shadow-[0_22px_60px_rgb(0_0_0_/0.42)] backdrop-blur-none`,
);
