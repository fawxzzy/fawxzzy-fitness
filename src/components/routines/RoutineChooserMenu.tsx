...
export const ROUTINE_CHOOSER_DUPLICATE_PANEL_CLASS_NAME = "min-h-0 rounded-[1rem] border border-[rgb(var(--border-strong)/0.16)] bg-[rgb(var(--surface-2-rgb)/0.54)] px-3 py-3";
...
export function RoutineDuplicateChooserPanel({
  ...
  return (
    <div className={cn(ROUTINE_CHOOSER_DUPLICATE_PANEL_CLASS_NAME, className)}>
      ...
      <span className="relative z-[1] flex min-w-0 flex-col gap-2 pl-1">
        <span className="flex items-start justify-between gap-3">
          <span className="inline-flex min-w-0 max-w-full flex-col items-start gap-[3px]">
            <span className="block text-[0.92rem] font-semibold text-[rgb(var(--text-primary)/0.98)]">
              {title}
            </span>
