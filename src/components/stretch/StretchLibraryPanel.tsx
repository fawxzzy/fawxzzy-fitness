  ...
  const heroPanel = (
    <AppPanel
      className={cn(
        ...
        isSessionContext ? "sticky top-0 z-20 border-b border-[rgb(var(--border-strong)/0.12)] bg-[rgba(7,14,24,0.96)] backdrop-blur-md" : undefined,
      )}
    >
        <div className={cn(appTokens.detailMediaCard, "gap-0 overflow-hidden border-transparent bg-transparent p-0 shadow-none")}>
          ...
          <div className="mx-4 mt-3 h-px bg-[linear-gradient(90deg,rgba(71,215,196,0),rgba(71,215,196,0.9),rgba(71,215,196,0))]" />
    ...
    <div className="space-y-3">
      ...
      <AppPanel className={cn(appTokens.detailSection, "space-y-3 p-3")}>
        <div className="space-y-1 px-2 pt-1 text-center">
          <EyebrowText as="p" className="text-[rgb(var(--accent)/0.9)]">Stretch library</EyebrowText>
        </div>
        ...
        <div className="space-y-2.5">
          <div className="space-y-2.5 rounded-[calc(var(--radius-lg)-0.35rem)] border border-[rgb(var(--border-strong)/0.08)] bg-[rgb(var(--surface-2)/0.72)] px-2.5 py-2.5">
            ...
            <div className="flex items-center justify-between gap-3 px-0.5">
              <p className="min-w-0 text-[10px] font-semibold uppercase tracking-[0.16em] text-[rgb(var(--accent)/0.94)]">
              ...
              {hasActiveRefinements ? (
                <button
                  ...
                  className="shrink-0 text-[10px] font-semibold uppercase tracking-[0.16em] text-[rgb(var(--text-secondary)/0.76)] transition-colors hover:text-[rgb(var(--accent)/0.94)]"
                >
                  Clear
                </button>
              ) : null}
            ...
            <div className="h-px bg-[linear-gradient(90deg,rgba(71,215,196,0),rgba(71,215,196,0.5),rgba(71,215,196,0))]" />
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "border-[rgb(var(--accent)/0.26)] bg-[rgb(var(--accent)/0.14)] text-[rgb(var(--accent)/0.98)]"
                    ...
                    >
                      ...
                      >
                        <div className="space-y-2 pt-1.5">
                          <div className="h-px bg-[linear-gradient(90deg,rgba(71,215,196,0),rgba(71,215,196,0.92),rgba(71,215,196,0))]" />
                ...
                {canLoadMore ? (
                  <li className="px-1 pt-1">
                    <button
                      ...
                      className="flex min-h-10 w-full items-center justify-center rounded-[1rem] border border-[rgb(var(--border-strong)/0.1)] bg-[rgb(var(--surface-3)/0.54)] px-3 text-[10px] font-semibold uppercase tracking-[0.16em] text-[rgb(var(--accent)/0.96)] transition-colors hover:bg-[rgb(var(--accent)/0.12)]"
                    >
