...
| Mode | Header action | Section visibility | Bottom dock | Exercise list interactivity | Add CTA |
| --- | --- | --- | --- | --- | --- |
| `default` | `Reorder` | Planned workout + exercise list | Single primary CTA (`Add`) | Interactive (tap opens inline editor) | Visible |
...
| `editing_exercise` | Back/close editor | Planned workout with single expanded exercise editor | Two-action dock (`View`, `Delete Exercise`) | Interactive only for the active inline editor | Hidden |
