...
export const PROGRESSION_RECEIPT_SCENARIOS = [
  {
    ...
    actions: [
      ...
      {
        id: "status-section-renders",
        label: "Progress Status section renders",
        type: "waitForText",
        text: "Progress Status",
        timeoutMs: 15000,
      },
      {
        id: "basis-explains-weight-only",
        label: "Promotion basis explanation renders",
        type: "waitForText",
        text: "Weight only",
        timeoutMs: 15000,
      },
      {
        id: "threshold-explains-top-range",
        label: "Rep threshold explanation renders",
        type: "waitForText",
        text: "Top half of range (10+ reps)",
        timeoutMs: 15000,
      },
      {
        id: "status-surface-exists",
        label: "Read-only progression status surface is mounted",
