...
function suggestDirectCommand(proposed, drafts) {
...
async function main() {
  ...
  const output = {
    ...
    suggestionPrimary: 'npm run playbook',
    suggestionDirect: suggestDirectCommand(statusCounts.proposed, draftsCount),
    reminder: 'If unsure what to run → npm run playbook',
  };
